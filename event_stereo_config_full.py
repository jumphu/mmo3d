...
train_pipeline = [
    ...
    dict(type='CustomPack3DDetInputs', 
         keys=['event_l', 'event_r', 'cam2ego_l', 'cam2ego_r', 'cam_intrinsic', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_depth'],
...
# 4. Runtime
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=60, val_interval=100) # Disable val during train to avoid crash
